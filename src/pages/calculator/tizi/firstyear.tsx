...
export function TiziFirstYearCalculator() {
  ...
  return (
    <div className="max-w-4xl px-4 py-8 mx-auto">
      <Helmet>
        <title>Calculateur de Notes - 1ère Année Médecine Tizi Ouzou</title>
        <meta
          name="description"
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8">
        ...
        <button
          onClick={resetGrades}
          className="flex items-center justify-center gap-2 px-4 py-2 ml-auto font-medium text-red-600 transition-colors bg-red-100 rounded-lg hover:bg-red-200"
        >
